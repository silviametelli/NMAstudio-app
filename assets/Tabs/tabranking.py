...
tab_ranking= dcc.Tabs(id='subtabs-rank1', value='subtab-rank1', vertical=False, persistence=True,
                         ...
                         dcc.Tab(label='P-scores Scatter plot', id='tab-rank2', value='Tab-rank2', className='control-tab',
                                 ...
                                 #     html.Div([
                                 #     dbc.Row([
                                 #         dbc.Col([html.P("Small values outcome 1", style={'display':'inline-block',  'padding-left':'20px'}),
                                 #             html.P(
                                 #                 "Beneficial",
                                 ...
                                 #                               'font-size': '10px',
                                 #                               'padding-right': '5px'})]),
                                 #         dbc.Col([html.P("Small values outcome 2", style={'display':'inline-block', 'padding-left':'20px'}),
                                 #             html.P(
                                 #                 "Beneficial",
