...
def get_stylesheet(node_size=False, classes=False, n_class=N_CLASSES, edg_col=DFLT_EDG_CLR, nd_col=DFLT_ND_CLR, edge_size=False,
                   pie=False, edg_lbl=False, nodes_opacity=1, edges_opacity=0.77):
