...
def __skt_all_forstplot(df):
    ...
    # low_rng = 10 ** np.floor(np.log10(low_rng))
        ...
        range_scale=[min(low_rng_min, -1, low_mix_min,low_direct_min,low_indirect_min,), 
    ...
    range_scale2=[min(low_rng_min, -1, low_mix_min,low_direct_min,low_indirect_min), 
                              max(up_rng_max, 2.25, up_mix_max+1, up_direct_max+1,up_indirect_max+1)]
    ...
    fig.update_layout(
        xaxis=dict(range=range_scale2,
                   tickvals=[i for i in range(int(min(low_rng_min, -1, low_mix_min, low_direct_min, low_indirect_min)+1),
                                      int(max(up_rng_max, 2.25, up_mix_max+1, up_direct_max+1, up_indirect_max+1))-1)],
                        ),
        showlegend=False,
        yaxis_visible=False,
        yaxis_showticklabels=False,
...
def __skt_direct_forstplot(df):
    ...
    # low_rng = 10 ** np.floor(np.log10(low_rng))
        ...
        range_scale=[min(low_rng_min, -1, low_mix_min,low_direct_min), 
                              max(up_rng_max, 2.25, up_mix_max+1, up_direct_max+1)]
    ...
    up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
    up_direct_max, low_direct_min = data_ex.direct.max(), data_ex.direct.min()
    range_scale2=[min(low_rng_min, -1, low_mix_min,low_direct_min), 
                              max(up_rng_max, 2.25, up_mix_max+1, up_direct_max+1)]
    ...
    fig.update_layout(
        xaxis=dict(range=range_scale2,
                    tickvals=[i for i in range(int(min(low_rng_min, -1, low_mix_min, low_direct_min)+1),
                                        int(max(up_rng_max, 2.25, up_mix_max+1, up_direct_max+1)-1))],
                        ),
        showlegend=False,
        yaxis_visible=False,
        yaxis_showticklabels=False,
...
def __skt_indirect_forstplot(df):
    for j in range(0, 380, 19):
        data_ex = df[j:j + 19]
        up_rng_max, low_rng_min = data_ex.CI_upper.mean(), data_ex.CI_lower.mean()
        up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
    ...
    # low_rng = 10 ** np.floor(np.log10(low_rng))
        ...
        range_scale=[min(low_rng_min, -1, low_mix_min,low_indirect_min,), 
                              max(up_rng_max, 2.25, up_mix_max+1,up_indirect_max+1)]
    ...
    up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
    up_indirect_max, low_indirect_min = data_ex.indirect.max(), data_ex.indirect.min()
    range_scale2=[min(low_rng_min, -1, low_mix_min,low_indirect_min,), 
                              max(up_rng_max, 2.25, up_mix_max+1,up_indirect_max+1)]
    ...
    fig.update_layout(
        xaxis=dict(range=range_scale2,
                    tickvals=[i for i in range(int(min(low_rng_min, -1, low_mix_min, low_indirect_min)+1),
                                        int(max(up_rng_max, 2.25, up_mix_max+1,  up_indirect_max+1)-1))],
                        ),
        showlegend=False,
        yaxis_visible=False,
        yaxis_showticklabels=False,
...
def __skt_PIdirect_forstplot(df):
    for j in range(0, 380, 19):
        data_ex = df[j:j + 19]
        up_rng_max, low_rng_min = data_ex.CI_upper.mean(), data_ex.CI_lower.mean()
        up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
...
def __skt_PIindirect_forstplot(df):
    for j in range(0, 380, 19):
        data_ex = df[j:j + 19]
        up_rng_max, low_rng_min = data_ex.CI_upper.mean(), data_ex.CI_lower.mean()
        up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
...
def __skt_directin_forstplot(df):
    for j in range(0, 380, 19):
        data_ex = df[j:j + 19]
        up_rng_max, low_rng_min = data_ex.CI_upper.mean(), data_ex.CI_lower.mean()
        up_mix_max, low_mix_min = data_ex.RR.max(), data_ex.RR.min()
