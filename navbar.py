...
NMASTUDIO_LOGO = "/assets/logos/NMAstudio_bold2.png"
...
def Navbar():
    home_button = dbc.NavItem(dbc.NavLink('HOME', href="/home", external_link=True,
                                          style = {'display':'inline-block', 'color':'white','font-family': "sans-serif ",
                                                   'font-size':'11px' }))
    doc_button = dbc.NavItem(dbc.NavLink('DOCUMENTATION', href="/doc", external_link=True,
                                         style = {'display':'inline-block', 'color':'white','font-family': "sans-serif ",
                                                  'font-size': '11px' }))
    navbar = dbc.Navbar([
            dbc.Col(html.Img(src=NMASTUDIO_LOGO, height="55px", style={'filter': 'invert()',
                                                                       'padding-left': '1.5%',
                                                                       'padding-top':'0.4%'}), sm=3, md=2),
            dbc.Col(dbc.Nav([home_button, doc_button], navbar=True)),
            dbc.Col(html.Img(src=CRESS_LOGO, height="60px"), style={'padding-right':'1.5%','padding-top':'0.4%','padding-bottom':'0.4%'},
                    width="auto" ),
        ],
        color="dark",
        dark=True,
