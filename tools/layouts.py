...
def real_homelayout():
    return html.Div([
                    ...
                    #                 Download(id="download-tuto")]),
                                    ...
                                    html.Br(),
                                    dbc.Row(html.Button('Upload your data',
                                             style={'color': 'white',
...
def upload_data():
    return html.Div(id='upload_page',style={'display':'none'},children=[
       ...
       dbc.Row( html.Img(src="/assets/icons/arrow.png",
        ...
        html.Div(file_upload_controls2,
        ...
        html.Br(),
        html.Div(id='outcomes_type', style={'display':'grid', 'justify-content': 'center'}),
        html.Br(),
        ...
        html.Br(),
        html.Div(id='variable_selection', style={'display':'grid', 'justify-content': 'center'}),
        html.Br(),
        ...
        html.Br(),
        html.Div(id='select_effect_modifier', style={'display':'grid', 'justify-content': 'center'}),
        html.Br(),
        dbc.Row( html.Img(src="/assets/icons/arrow.png",
                style={'width': '60px'}), 
